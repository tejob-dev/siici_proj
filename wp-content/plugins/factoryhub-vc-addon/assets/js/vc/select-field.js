!( function($) {
	...
	$( function() {
		...
		$( 'body' ).find( '.wpb_el_type_select_category, .wpb_el_type_select_product_cat, .wpb_el_type_select_portfolio' ).each( function( ) {
			...
			if( dataParam == 'categories' || dataParam == 'portfolios' ) {
